---
title: "Overview of R Basic Code"
output:
  github_document:
    html_preview: true
...
knitr::opts_chunk$set(
  fig.path = "Figures/CodeOverview/",
  fig.width = 7,
  fig.height = 4.5
)
set.seed(42)  # keep re-renders byte-identical
```

# Overview of R basic R code

**Overview of simple R commands for generating vectors. Plot and hist. Code for loops. The idea is for students to be able to, at least, superficially, understand provided code in the next sessions.**

---

## Vectors

The vector is the basic data structure in R for storing collections of values. Understanding vectors is essential for working with data and running simulations.
...
Vector indices in R start from 1 (unlike many languages that start from 0).
...
Loops allow you to repeat operations multiple times—essential for simulations.
...
This combines all three Session 3 skills: vectors store the data, loops run the simulation, and histograms visualize the results.
